        ...
        <View style={styles.container}>
            ...
            <View style={styles.subContainerMiddle}>
                ...
                <View style={styles.subContainerRight}>
                    ...
                    <View style={styles.subContainerRightRatting}>
                        <Image source={require("../../assets/icon/ratting.png")}
                            resizeMode="contain"
                            style={styles.image}
                            width={24}
                            height={24}
                        />
                        <Text style={styles.containerTextBold}>
                            4.9
                        </Text>
                    </View>
                </View>
            ...
            <View style={styles.subContainerMiddle}>
                <View style={styles.subContainerLeft}>
                    ...
                    />
                    <View>
                        <Text style={styles.containerTextFair}> Total Fair: ₹ 920</Text>
                        <Text style={styles.containerTextAddFair}> Add ₹ 920 to Avoid Cash</Text>
                        <TouchableOpacity
                            style={styles.containerTextAddMoney}
                        >
                            <Text style={{ color: "white", textAlign: "center" }}>Add Money</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={styles.subContainerRight}>
