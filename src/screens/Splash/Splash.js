...
import { StyleSheet, View, Text,StatusBar, Button, Dimensions, Image, TouchableOpacity, AppRegistry, ImageBackground } from 'react-native';
    ...
    return(
        <View style={styles.container}>
         ...
         <ImageBackground 
          ...
          easing="ease-in"
          >
            <Text style={[styles.title, {color: colors.text}]}>Simple! Deliver Your   Goods</Text>
