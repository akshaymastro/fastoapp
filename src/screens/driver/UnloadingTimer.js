...
const UnloadingTimer = ({navigation}) => {
    return (
        ...
        <View style={styles.subContainer}>
            ...
            <View style={styles.subContainerContent}>
                ...
                <View style={styles.rideInfo}>
                    <View style={styles.rideInfoPickup}>
                        ...
                        <Text style={styles.rideInfoPickupText}>23/20, Patel Nagar, New Delhi New Delhi</Text>
                    </View>
                    <View style={styles.rideInfoPickup}>
                        <Text style={styles.rideInfoDropTitle}>Reciever Details</Text>
                       <View style={{flexDirection:"row",alignItems:"center"}}>
                        <View>
                            <Text style={styles.rideInfoPickupText1}>Name: Ramesh Kumar</Text>
                            <Text style={styles.rideInfoPickupText1}>Mobile:7017364693</Text>
                        </View>
                        <TouchableOpacity>
                            <Image
            ...
            <View style={[styles.bottom, { marginVertical: 10 }]}>
                <View style={styles.timer}>
                    <Text style={styles.timerText}>Unloading Timer</Text>
                    <Text style={styles.timerText}>59:00 Min</Text>
                </View>
                <TouchableOpacity
