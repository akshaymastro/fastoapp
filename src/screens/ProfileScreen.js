    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.account}>
          <View>
            <Text style={styles.mainText}>Vishal Kardam</Text>
            <View style={styles.account}>
              <Image
                style={styles.flag}
      ...
      <View style={styles.profileBottom}></View>
      <View style={styles.accountBootom}>
        <View style={styles.uinImageView}>
          <Image
            style={styles.uinImage}
            source={require("../assets/icon/uin.png")}
          />
        </View>
      ...
      <View style={styles.accountBootomNext}>
        ...
        <View style={styles.Uid}>
          <LinearGradient
            ...
            style={styles.linearGradient}
          >
            <Text style={styles.uinText}>
              Email: vishalkardam1505@gmail.com
            </Text>
          </LinearGradient>
        </View>
      </View>
      <View style={styles.accountBootomNext}>
        ...
        <View style={styles.Uid}>
          ...
          <View style={styles.account}>
            <LinearGradient
              colors={["#fdf0f0", "#eaeaf1", "#d5e3f2"]}
              style={styles.linearGradientHalf}
            >
              <Text style={styles.uinText}>Sirsa </Text>
            </LinearGradient>
            <LinearGradient
              colors={["#fdf0f0", "#eaeaf1", "#d5e3f2"]}
              style={styles.linearGradientHalfSecond}
            >
      ...
      <View style={styles.uploadAadharView}>
        <TouchableOpacity style={styles.uploadAadhar}>
          <Image
            style={styles.uploadAadharImage}
